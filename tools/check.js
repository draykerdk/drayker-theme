...
check(layout.includes('application/ld+json') && layout.includes('https://schema.org'), 'structured data graph is missing');
check(layout.includes('"@type": "WebSite"') && layout.includes('"@type": "WebPage"'), 'site and page entities are missing');
check(layout.includes('https://drayker.com/#organization'), 'shared organization identity is missing');
check(layout.includes('icon-512.png'), 'crawlable organization logo is missing');
check(layout.includes('meta property="og:site_name"'), 'Open Graph site name is missing');
check(layout.includes('meta name="twitter:title"') && layout.includes('meta name="twitter:description"'), 'Twitter metadata is incomplete');
